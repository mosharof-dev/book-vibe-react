...
const BookCard = ({book}) => {
    return (
        <div>
               <div  className="card h-full bg-base-100 border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                            
                            {/* Image Section */}
                            <figure className="bg-base-200 py-8 rounded-2xl">
                                <img src={book.image} alt={book.bookName} className="h-40 object-cover drop-shadow-lg" />
                            </figure>
